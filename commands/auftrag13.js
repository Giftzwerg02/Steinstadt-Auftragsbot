...
const aufträge11 = require('../aufträge/13.json')

module.exports = {
    name: 'auftrag13',
    description: 'Auftrag mit der ID 13 ausführen',
    execute(message) {
        var rndmauftragsnummer13 = Math.floor(Math.random() * 25)
        message.delete();
        const embed = new Discord.MessageEmbed()
        .setTitle(`${aufträge13[rndmauftragsnummer13].nummer}`)
        .setDescription(`${aufträge13[rndmauftragsnummer13].fracht} \n
                        ${aufträge13[rndmauftragsnummer13].gewicht} \n
                        ${aufträge13[rndmauftragsnummer13].von}\n
                        ${aufträge13[rndmauftragsnummer13].nach} \n
                        ${aufträge13[rndmauftragsnummer13].transport} \n
                        ${aufträge13[rndmauftragsnummer13].maxSpd} \n
                        ${aufträge13[rndmauftragsnummer13].money} \n`)
            ...
            .then(async m => {
                ...
                collector3.on('collect', () => {
                    ...
                    collector1.on('collect', () => {
                        ...
                        request.send(`{ "cash": 0, "bank": ${aufträge13[rndmauftragsnummer13].cash} }`);
                        console.log(`{ "cash": 0, "bank": ${aufträge13[rndmauftragsnummer13].cash} }`);
                        ...
                        request.onloadend = function() {
                            ...
                            `${JSON.stringify(aufträge13[rndmauftragsnummer13], null, 4)}` + 
